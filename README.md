...
- Vault ingress / VSO connection base: `cluster/vault/vault-config/` (host and `VaultConnection` address patched by client repo overlay; URL `//cluster/vault/vault-config`)
